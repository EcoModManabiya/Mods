namespace Eco.Mods.TechTree
{
    ...
    public partial class MYBoiledTroutMisoSauceRecipe : Recipe
    {
        public MYBoiledTroutMisoSauceRecipe()
        {
            ...
            this.CraftMinutes = CreateCraftTimeValue(typeof(MYBoiledTroutMisoSauceRecipe), Item.Get<MYBoiledFishItem>().UILink(), 15, typeof(MYGoldenProportionOfBoildSpeedSkill)); 
